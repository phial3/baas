...
public class OrderNodeDomain extends NodeDomain {

    @Override
    public String getVolumeMountPath() {
        return "/etc/hyperledger/orderer/";
    }
    ...
    public Properties getProperties() {
        ...
        properties.setProperty("ordererWaitTimeMilliSecs", "60000");
    ...
    public Orderer newOrderer(HFClient fabClient) throws InvalidArgumentException {
        return fabClient.newOrderer(getDnsName(), getUrl(), getProperties());
    }
