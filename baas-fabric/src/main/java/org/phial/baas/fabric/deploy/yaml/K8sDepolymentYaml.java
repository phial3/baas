...
public class K8sDepolymentYaml {
    ...
    public void addCommands(String command) {
        ...
        JSONArray commans = container.getJSONArray("command");
        if (commans == null) {
            commans = new JSONArray();
            container.put("command", commans);
        }
        commans.add(command);
    }
    ...
    public void addVolumeMount(String mountPath, String name) {
        addVolumeMount(mountPath, name, null);
    }

    public void addVolumeMount(String mountPath, String name, String subPath) {
        JSONObject container = getContainer();
        ...
        if (!StringUtils.isBlank(subPath)) {
            volumeMount.put("subPath", subPath);
        }
    ...
    public void addFlexVolume(String name, String nodeName) {
        ...
        options.put("driver.root", new StringType(CommonFabricConstant.DATA_PATH + CommonFabricConstant.PROFILE +
                "/podlog/app/${kubernetes.io/pod.namespace}/" + nodeName + "/${kubernetes.io/pod.name}"));
