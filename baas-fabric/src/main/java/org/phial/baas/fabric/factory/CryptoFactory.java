...
public final class CryptoFactory {
    ...
    public UserContext createRegister(CANodeDomain caNode, CryptoEnum.CryptoUserType userType) {
...
//            user.update();
    ...
    public UserContext createCrypto(CANodeDomain caNode, String caId, Map<String, Object> attr, CryptoEnum.CryptoUserType userType) {
        Organization organization = caNode.getFabricOrg();
        String orgDomain = organization.getDomain();
        try {
            //示例化client
